...
const Footer = () => {
    return ( 
        <footer className="font-sans tracking-wide bg-[#27282b] py-12 px-8">
      <div className="max-w-6xl max-lg:max-w-screen-md mx-auto">
        <div className="grid max-md-grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <h4 className="text-gray-300 font-bold text-lg">About Us</h4>
            <p className="text-sm mt-6 text-gray-400 leading-relaxed">Need a ticket to your favorite event or show but don't know where to get it? Wanna make reservations to that dream hotels for that vacation with mama but don't know where to go? Wanna watch your favorite artist live but dont know were to get your tickets? worry no more, we got you covered!!! </p>
            ...
            <ul className="grid sm:grid-cols-2 mt-12 gap-2">
              <li className="flex items-center max-sm:mb-8">
                ...
                <a href="javascript:void(0)" className="text-gray-300 text-sm ml-4">
                  <small className="block">Tel</small>
                  <strong>+254-769-992344</strong>
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="javascript:void(0)" className="text-gray-300 text-sm ml-4">
                  ...
                  <strong>info@tikosasa.com</strong>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-gray-300 font-bold text-lg">Newsletter</h4>
            <p className="text-sm mt-6 text-gray-400 leading-relaxed">Subscribe to our newsletter and stay up to date with the latest news,
            ...
            <div className="bg-[#343538] flex px-2 py-1 rounded-full mt-12">
              ...
              <button type='button'
                className="bg-gray-300 hover:bg-white transition-all text-gray-600 font-semibold text-sm rounded-full px-5 py-2 ml-4">Submit</button>
            </div>
              ...
              <li className="bg-[#343538] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="javascript:void(0)">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="fill-gray-300"
                    ...
                    <g fill="none" stroke="#d1d5db" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
        ...
        <div className="lg:flex lg:item-center mt-12">
          <ul className="flex flex-wrap gap-4">
            <li>
              <a href='javascript:void(0)' className='text-gray-400 hover:text-gray-200 text-sm'>Terms of Service</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='text-gray-400 hover:text-gray-200 text-sm'>Privacy Policy</a>
            </li>
            <li>
              <a href='javascript:void(0)' className='text-gray-400 hover:text-gray-200 text-sm'>Security</a>
            </li>
          </ul>

          <p className='text-sm text-gray-400 lg:ml-auto max-lg:mt-6'>© Mark Njenga. All rights reserved.</p>
        </div>
      </div>
    </footer>
     );
